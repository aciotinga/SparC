...
class TestExpectationCompatibility:
    ...
    def test_mismatched_cardinality_raises(self):
        ...
        l2 = CategoricalInputNode(
            scope_var=0, probabilities=[0.3, 0.3, 0.4]
        )
        with pytest.raises(ValueError, match="expectation incompatible"):
            exp_query(l1, l2)
...
class TestCWCompatibility:
    ...
    def test_grad_matches_forward_on_valid_pair(self):
        l1 = CategoricalInputNode(scope_var=0, probabilities=[0.3, 0.7])
        l2 = CategoricalInputNode(scope_var=0, probabilities=[0.55, 0.45])
        v = cw_distance(l1, l2)
...
class TestGCWCompatibility:
    def test_coupling_materializes_for_valid_pair(self):
        l1 = CategoricalInputNode(scope_var=0, probabilities=[0.5, 0.5])
        l2 = CategoricalInputNode(scope_var=0, probabilities=[0.5, 0.5])
    ...
    def test_crossterm_finite_on_valid_pair(self):
        l1 = CategoricalInputNode(scope_var=0, probabilities=[0.4, 0.6])
        l2 = CategoricalInputNode(scope_var=0, probabilities=[0.2, 0.8])
    ...
    def test_disjoint_support_near_zero(self):
        l1 = CategoricalInputNode(scope_var=0, probabilities=[1.0, 0.0])
        l2 = CategoricalInputNode(scope_var=0, probabilities=[0.0, 1.0])

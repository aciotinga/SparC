...
class TestPNormMetric:
    ...
    def test_symmetry(self):
        p = [0.25, 0.75]
        q = [0.6, 0.4]
        l1 = CategoricalInputNode(scope_var=0, probabilities=p)
        l2 = CategoricalInputNode(scope_var=0, probabilities=q)
...
class TestDualMetricsGCW:
    ...
    def test_custom_metric_objects(self):
        ...
        l2 = CategoricalInputNode(scope_var=0, probabilities=[0.6, 0.4])

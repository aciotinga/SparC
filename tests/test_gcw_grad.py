    ...
    def test_sum_sum_phi_grad_matches_fd(self):
        ...
        def f_value(phi):
            ...
            return gcw_crossterm(
                circ1, SumNode(id=5, children=[c2a, c2b], parameters=list(phi))
            )
...
class TestProductGradients:
    def test_product_leaf_grad_matches_fd(self):
        ...
        def f_value(probs):
            ...
            return gcw_crossterm(circ1, ProductNode(id=5, children=[c2a, c2b]))
...
class TestMixedGradients:
    ...
    def _build_circuit1(self, rng):
        ...
        return SumNode(id=6, children=[prodA, prodB], parameters=[0.4, 0.6])
    ...
    def test_sum_grad_in_sum_of_products(self):
        ...
        def build_circ2(theta):
            l1 = CategoricalInputNode(id=10, scope_var=0, probabilities=[0.55, 0.25, 0.2])
            l2 = CategoricalInputNode(id=11, scope_var=1, probabilities=[0.3, 0.5, 0.2])
            l3 = CategoricalInputNode(id=12, scope_var=0, probabilities=[0.15, 0.6, 0.25])
            l4 = CategoricalInputNode(id=13, scope_var=1, probabilities=[0.7, 0.1, 0.2])
...
class TestGradientAscentSmoke:
    ...
    def test_ascent_increases_crossterm(self):
        ...
        leaf_ref = CategoricalInputNode(id=0, scope_var=0, probabilities=list(p_fixed))
